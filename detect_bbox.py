                            ...
                            for *xyxy, conf, cls in reversed(det):
                                ...
                                if save_img or view_img:  # Add bbox to image
                                    ...
                                    if names[int(cls)] == 'bottle' or names[int(cls)] == 'orange' or names[int(cls)] == 'apple':
                                        ...
                                        camera_coordinate2 = ((int(xyxy[0]) - ppx) * zz1 / fx, (int(xyxy[1]) - ppy) * zz1 / fy, zz1)

                                        camera_coordinate3 = ((int(xyxy[2]) - ppx) * zz1 / fx, (int(xyxy[3]) - ppy) * zz1 / fy, zz1)

                                        last_cord = [camera_coordinate2[0]/1000, camera_coordinate2[1]/1000, camera_coordinate2[2]/1000,
                                                     camera_coordinate3[0]/1000, camera_coordinate2[1]/1000, camera_coordinate3[2]/1000,
                                                     camera_coordinate3[0]/1000, camera_coordinate3[1]/1000, camera_coordinate3[2]/1000,
                                                     camera_coordinate2[0]/1000, camera_coordinate3[1]/1000, camera_coordinate3[2]/1000]
