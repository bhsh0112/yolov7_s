...
def detect(save_img=False):
    global stop
    object_state_pub = rospy.Publisher('/find_states', Bool, queue_size=10)
    cmd_vel = rospy.Publisher('/cmd_vel/chassis_sub', Twist, queue_size=1)
        ...
        while (not stop):
            ...
            for path, img, im0s, vid_cap in dataset:
                ...
                for i, det in enumerate(pred):  # detections per image
                    ...
                    if len(det):
                        ...
                        for *xyxy, conf, cls in reversed(det):
                            ...
                            if save_img or view_img:  # Add bbox to image
                                ...
                                if names[int(cls)] == 'bottle' or names[int(cls)] == 'orange' or names[
                                    int(cls)] == 'apple':
                                    ...
                                    zz1 = compute_depth(depth_image, bbox)
                                    move_cmd.linear.y = 0
                                    move_cmd.linear.x = 0
                                    move_cmd.linear.z = 0
                                    cmd_vel.publish(move_cmd)
                                    ...
                                    last_cord = [camera_coordinate2[0] / 1000, camera_coordinate2[1] / 1000,
                                                 camera_coordinate2[2] / 1000,
                                                 camera_coordinate3[0] / 1000, camera_coordinate2[1] / 1000,
                                                 camera_coordinate3[2] / 1000,
                                                 camera_coordinate3[0] / 1000, camera_coordinate3[1] / 1000,
                                                 camera_coordinate3[2] / 1000,
                                                 camera_coordinate2[0] / 1000, camera_coordinate3[1] / 1000,
                                                 camera_coordinate3[2] / 1000]
                                    # with open("test.txt", 'w', encoding="utf-8") as f:
                                    #     f.write(camera_coordinate2)
                                    #     f.write(camera_coordinate3)
                                    np.savetxt("test.txt", last_cord, fmt='%f')
                                    np.savetxt("bbox.txt", bbox, fmt='%f')

                                    print("camera_cordinate1:", camera_coordinate1)
                                    print("camera_cordinate2:", camera_coordinate2)
                                    print("camera_cordinate3:", camera_coordinate3)
                                    # print(depth_image)
                    ...
                    csv_array = np.loadtxt('test.txt')
                    print("csv_array", csv_array)
                    # re = open("test.txt")
                    # lines = re.readlines()
                    # print(lines)
                    # re.close()
...
class ObjectPerception:
    ...
    def __init__(self):
        ...
        rospy.loginfo("object perception init done")
